...
*Вход: 79, Изход: 0x100lv 1x50lv 1x20lv 1x5lv 2x2lv 0x1lv*

**Задача 8:** 
Въвежда се цяло число n - извеждаме сумата на всички числа по-малки или равни на числото които се делят на 3
